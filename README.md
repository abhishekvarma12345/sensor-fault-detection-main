...
```bash
https://github.com/abhishekvarma12345/sensor-fault-detection-main.git
```
...
export MONGODB_URL="mongodb+srv://<username>:<password>@cluster0.nnfqq.mongodb.net/?retryWrites=true&w=majority"
